const faqs = [
  ...
  },
  {
    ...
    answer:
      "Watering frequency depends on the plant type, environment, and season. Generally, check the soil moisture before watering.",
  },
  {
    question: "Best location for indoor plants to thrive?",
    answer:
      "Most indoor plants prefer bright, indirect light. Avoid direct sunlight and drafts.",
  },
  {
    question: "Effective ways to control plant pests?",
    answer:
      "Regularly inspect your plants, use insecticidal soap or neem oil, and provide good air circulation.",
  },
  {
    question: "Plants suitable for low-light indoor spaces?",
    answer:
      "Snake plants, ZZ plants, and cast iron plants are known to tolerate low-light conditions.",
  },
];
