...
function ShopByCategory() {
  const categories = [
    ...
    { image: "/Shop By Category/indoor.png", name: "Indoor" },
    { image: "/Shop By Category/terracebalcony.png", name: "Terrace" },
    { image: "/Shop By Category/officedesk.png", name: "Office Desk" },
  ];
