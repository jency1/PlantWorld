...
const DP_OrdersTable = ({ orders, onView }) => {
  const { dpToken } = useContext(DP_AuthContext);
  const { fetchAllOrders } = useContext(DP_OrdersContext);
